...
public class AadharValidation implements Runnable {
  private CyclicBarrier cyclicBarrier;
  private int timeInSecs;
  private String result;

  public AadharValidation(CyclicBarrier cyclicBarrier, int timeInSecs,String result) {
  ...
  public void run() {
    try {
      ...
      this.result = "Aadhar Validation Successful";
      cyclicBarrier.await();
